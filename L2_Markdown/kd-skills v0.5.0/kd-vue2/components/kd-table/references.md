...
> 组件标签：`<kd-table>` · 包：`@kdocs/kdesign-vue`
...
| resizable | 对应列是否可以通过拖动改变宽度（需要在 kdv-table 上设置 border 属性为真） | boolean | — | true |
...
| empty-text | 空数据时显示的文本内容，也可以通过  设置slot="empty" | String | — | 暂无数据 |
